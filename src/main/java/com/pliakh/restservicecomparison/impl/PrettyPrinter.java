...
public class PrettyPrinter {
    ...
    void infoPretty(String message) {
        LOGGER.info(message);
    }

    void infoPretty(String message, String parameterName, Object arg1, Object arg2) {
        LOGGER.info(msg(message, parameterName, arg1, arg2));
    }

    public void warnPretty(String message) {
        LOGGER.warn(message);
        commonWarnings.add(message);
    }

    void warnPretty(String message, String parameterName, Object arg1, Object arg2) {
        LOGGER.warn(msg(message, parameterName, arg1, arg2));
        commonWarnings.add(msg(message, parameterName, arg1, arg2));
    }

    void errorPretty(String message) {
        LOGGER.error(message);
    }

    void debugPretty(String message) {
        LOGGER.debug(message);
    }

    void prettyDebugTwoJsons(String json1, String json2) {
